...
public class GameOneActivity extends AppCompatActivity {
    ...
    ImageView Img;
    TextView title;
    int questionConut = 20;
    ArrayList<Integer> IDchoice = new ArrayList<Integer>();
    String Answer;
    int score = 0, num = 1;

    public String c, c1, c2, c3, c4, image;
    ...
    private void setQuestion(Integer IDchoice) {
        ...
        final String URL = Host + "listgame_one.php";
                        ...
                        new Response.Listener<String>() {
                            ...
                            public void onResponse(String s) {
                                ...
                                try {
                                    ...
                                    image = getResources().getString(R.string.host)+"imagegames/" + o.getString("question_image");
                                    ...
                                    Img.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View v) {
                                            ...
                                            Intent i = new Intent(GameOneActivity.this, ShowImage.class);
                                            i.putExtra(EXTRA_MESSAGE, image);
                                            startActivity(i);
                                        }
                                    });
    ...
    public void choiceAns(View v) {
        ...
        if (buttonText.equals(Answer)) {
            Toast.makeText(GameOneActivity.this, "ถูกแล้ว", Toast.LENGTH_SHORT).show();
            score++;
        } else {
            Toast.makeText(GameOneActivity.this, "ผิด แล้ว", Toast.LENGTH_SHORT).show();
        }
        if (IDchoice.isEmpty()) {
            DialogBox();
                ...
                .setPositiveButton("ออก", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        if(score>=15){
                            ...
                            score_user();
                            Toast.makeText(GameOneActivity.this, "ยินดีด้วยคุณได้คะแนน เพิ่ม 1 คะแนน", Toast.LENGTH_SHORT).show();
                        }
                        finish();
                    }
                })
    ...
    private void score_user() {
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(GameOneActivity.this);
        ...
        new android.app.AlertDialog.Builder(this)
                ...
                .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        GameOneActivity.super.onBackPressed();
                    }
                }).create().show();
    }
}